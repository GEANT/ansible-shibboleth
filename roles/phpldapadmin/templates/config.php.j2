...
$config->custom->appearance['show_top_create'] = false;
...
$config->custom->appearance['tree_display_format'] = array('%rdnValue');
...
* Date attributes *
*********************************************/
$config->custom->appearance['date_attrs'] = array('schacDateOfBirth'=>'%Y%m%d');

/*********************************************
* Date show format *
*********************************************/
$config->custom->appearance['date'] = '%e %B %Y';
...
### TODO - ENABLE FOR CUSTOM CREATION PAGES
$config->custom->appearance['stylesheet'] = 'custom.css';
$config->custom->appearance['action_after_creation'] = 1;
...
#  $servers->setValue('login','bind_id','cn=Manager,{{ pla['ldap']['basedn'] }}');
